      ...
      <Modal visible={visible} transparent animationType="fade" onRequestClose={() => setVisible(false)}>
        <View className="flex-1 justify-center items-center bg-black/60">
          <ThemedView className="w-72 rounded-2xl p-6 gap-4">
            <ThemedText className="text-xl font-semibold">Sell All Shares</ThemedText>
            <ThemedText themeColor="textSecondary">
              This will sell all <ThemedText className="font-bold">{quantity} shares of {ticker}</ThemedText> at the current price. The operation will be recorded in your history.
            </ThemedText>
